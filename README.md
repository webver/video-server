...
Media library - [http://github.com/deepch/vdk](https://github.com/deepch/vdk). License is [MIT](https://github.com/deepch/vdk/blob/master/LICENSE). **NOT ACTUAL: We are using fork actually - https://github.com/LdDl/vdk**
